...
-- Oops! Someone spelled Kevin's surname wrong! Change it to reflect the proper spelling (McDermott).
UPDATE people SET name = 'Kevin McDermott' WHERE name = 'Kevin	McDonalds';

-- Return ONLY Stan Tarnev's name from the 'people' table.
...
-- We forgot one of the main characters! Add Colin Bell to the 'people' table
INSERT INTO people (name) VALUES ('Colin Bell');

-- Ally has decided to hijack our movie evening, Remove him from the table of people.
